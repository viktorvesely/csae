...
class CSAE(nn.Module):
    ...
    def contrastive_loss(self, encoded):
        ...
        # This is not used anymore but
        # Contrastive loss works by splitting the channels into 2 groups - common and different
        # Negative pairs need to be close with common groups but different with different groups
